...
analogous relationships, not a pile of swatches). Reserve a deliberate hard colour
break only for the rare place it is meant — a footer stepping onto its own
...
a scroll-driven reveal; a kinetic detail. The bar is professional with a heartbeat, not professional and asleep.
